...
using Nop.Plugin.DiscountRules.BXGY.Models;
...
namespace Nop.Plugin.DiscountRules.BXGY.Controllers
{
    ...
    public class DiscountRulesBXGYController : BasePluginController
    {
        #region Fields
        ...
        public DiscountRulesBXGYController(ICustomerService customerService,
        ...
        public IActionResult Configure(int discountId, int? discountRequirementId)
        {
            ...
            return View("~/Plugins/DiscountRules.BXGY/Views/Configure.cshtml", model);
        }
